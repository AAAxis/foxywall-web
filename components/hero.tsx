...
import { Smartphone, Chrome, ArrowRight } from "lucide-react"
...
export function Hero() {
  ...
  return (
    <section className="pt-24 pb-20 md:pt-32 md:pb-28 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-br from-orange-200/40 via-amber-100/30 to-transparent rounded-full blur-3xl -translate-y-1/4 translate-x-1/4" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-gradient-to-tr from-blue-100/30 via-transparent to-transparent rounded-full blur-3xl translate-y-1/4 -translate-x-1/4" />
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          {activeTab === "extension" && (
            <div className="space-y-4">
              ...
              <Button className="bg-primary text-primary-foreground hover:bg-primary/90 rounded-full px-8 py-3 font-semibold gap-2">
