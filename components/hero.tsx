            ...
            {activeTab === "mobile" && (
              ...
              >
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  <span
                    aria-disabled="true"
                    className="inline-flex items-center gap-2 bg-foreground text-background px-6 py-3 rounded-xl font-semibold opacity-60 cursor-not-allowed"
                  >
