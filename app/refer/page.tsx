      ...
      <div className="relative z-10 max-w-[440px] w-full px-5 text-center">
        ...
        <div className="pt-16 mb-8">
          ...
          <p className="text-[#999] text-base leading-relaxed">
            Unblock everything. Stay private. No credit card needed.
          </p>
        </div>
        ...
        <div className="text-left bg-[#111] rounded-2xl p-6 mb-8">
          ...
          {steps.map((s, i) => (
            <div key={i} className="flex gap-3 mb-3 last:mb-0">
              <div className="w-7 h-7 bg-[#ff6b35] rounded-full flex items-center justify-center text-sm font-bold shrink-0">
                {i + 1}
              </div>
        ...
        <div className="py-6 pb-10 text-[#333] text-xs">
          <p>FoxyWall VPN by <a href="https://holylabs.net" className="text-[#666] no-underline">Holylabs Ltd</a></p>
          <p className="mt-2">
            <a href="https://apps.apple.com/app/id6757646633" className="text-[#666] no-underline">App Store</a>
            {" · "}
            <a href="https://play.google.com/store/apps/details?id=com.theholylabs.rock" className="text-[#666] no-underline">Google Play</a>
          </p>
        </div>
      </div>
    </div>
